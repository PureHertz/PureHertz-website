...
![Lattice Diamondのダウンロードページ](Lattice-FPGA_1.png){width=250px}
...
開発ボード/デバイス上では、下図のようにプルアップ/プルダウン抵抗を配します。全てプルアップしてしまったり高めの抵抗を使ってしまったりすると、通信が上手くいかないことがあります。（参考: [FTDI2232を用いたJTAG通信 Machxo2書き込み](https://meerstern.seesaa.net/article/471983173.html)）

![JTAG信号のプルアップ/プルダウン](Lattice-FPGA_pullupdown.png)
